...
export class GestionUtilisateurService {
  ...
  private jobLlist$ = new BehaviorSubject<GestionUtilisateur[]>([]);
...
updateUserliste(id: number,gestionUser:GestionUtilisateur):Observable<GestionUtilisateur> {
...
private _search(): Observable<SearchResult> {
  ...
  return of({ jobList: [], total: 0 }); // Remplacer [] et 0 par les données réelles obtenues du backend
}
}
